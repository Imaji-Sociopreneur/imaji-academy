            ...
            <div class="row">
                <div class="col-lg-8 posts-list">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                @isset($c ->id_user)
                                                    @if($c -> id_user==\Illuminate\Support\Facades\Auth::id())
                                                        <div class="reply-btn">
                                                            <form action="{{route('comment-destroy-news', [$c->id, $b->id]) }}" method="POST" style="display: inline">
                    ...
                    <div class="comment-form">
                        <h4>Leave a Reply</h4>
                        <form method='post' class="form-contact comment_form"  action="{{route('comment-store-news',$datarealnews->id)}}" id="commentForm">
                            @csrf
                            <div class="row">
                                <div class="col-12">
